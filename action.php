<?php
	...
	if (isset($_POST['action']) && isset($_POST['action']) == 'order') {
	  ...
	  $stmt = $conn->prepare('INSERT INTO orders (name,email,phone,address,pmode,due_date,products,amount_paid)VALUES(?,?,?,?,?,?,?,?)');
	  $stmt->bind_param('ssssssss',$name,$email,$phone,$address,$pmode,$due_date,$products,$grand_total);
	  $stmt->execute();
